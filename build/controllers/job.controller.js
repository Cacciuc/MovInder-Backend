...
* acts as no input
  *
  */
router.get('/search/:name/:company_name/:description/:wage/:wagePerHour/:start_before/:start_after/:end_before/:end_after/:percentage_more/:percentage_less', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get('/search/company/:company_id/:approved', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.put('/noNewEdit/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
