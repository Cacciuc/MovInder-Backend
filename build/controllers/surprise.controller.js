...
exports.SurpriseController = void 0;
 ...
 */
router.get('/log', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get('/log/:cookie', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get('/log/job/:cookie', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cookie = req.params.cookie;
    const instances = yield surpriseLog_model_1.SurpriseLog.findAll({
        where: {
            cookie: cookie,
 ...
 */
router.get('/log/:type/all', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get('/log/:job/job/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get('/:cookie', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cookie = req.params.cookie;
