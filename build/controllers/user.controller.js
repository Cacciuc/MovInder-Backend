 ...
 */
router.get('/connTest', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.statusCode = 200;
 ...
 */
router.get('/salt/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get('/:email_v/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get('/:id/:password', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id);
 ...
 * */
router.put('/:id/:newPassword', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id);
    const instance = yield user_model_1.User.findById(id);
    if (instance == null) {
        res.statusCode = 404;
